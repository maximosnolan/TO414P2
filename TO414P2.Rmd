...
summary(hoteldata)
str(hoteldata)
# Store the original data set to a new one for collinearity check
hotel_cor_data = hoteldata
```
...
```{r}
hoteldata_numeric <- hotel_cor_data[,sapply(hotel_cor_data, is.numeric)]
