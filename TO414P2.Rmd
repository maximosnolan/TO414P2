...
CrossTable(x = knn_test_labels, y = knn_predict, 
           prop.chisq=FALSE)
confusionMatrix(as.factor(knn_test_labels), as.factor(knn_predict), positive = "1")
```

**Summary**
The optimal K value we choose for the KNN model is 10. From the KNN prediction results, we can see there are 5170 false positive and 6052 false negative. The overall accuracy is 81.2%.
