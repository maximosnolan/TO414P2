...
knn_predict = predict(knn.train, knn_test)
...
confusionMatrix(as.factor(sms_test_labels), as.factor(sms_test_pred3), positive = "1")
...
CrossTable(x = stacked_test$hotel_test.is_canceled, y = stacked_predict_improved, prop.chisq=FALSE)
confusionMatrix(as.factor(stacked_test$hotel_test.is_canceled), as.factor(stacked_predict_improved), positive = "1")
```
