...
CrossTable(x = hotel_test$is_canceled, y = lroutcome, prop.chisq=FALSE)
confusionMatrix(as.factor(hotel_test$is_canceled), as.factor(lroutcome), positive = "1")
```
...
# 
CrossTable(x = hotel_test$is_canceled, y = dtoutcome, prop.chisq=FALSE)
confusionMatrix(as.factor(hotel_test$is_canceled), as.factor(dtoutcome), positive = "1")
```
